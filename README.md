...
| `--ignoreExtraOutputs`       | Allows plugins with multiple output buses and writes only the main output bus to the output file. Extra output buses are still present for plugin processing, but they are ignored when writing the WAV.                                                                                                                                                                                                                                                                                       | No                               |
...
By default, Plugalyzer only supports a single output bus. The amount of channels can be specified using the `--outChannels` option.
...
For plugins with multiple output buses, pass `--ignoreExtraOutputs` to write only the main output bus to the output file.
